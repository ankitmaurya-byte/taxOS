...
export function AdminFilings() {
  ...
  return (
    <div className="space-y-5 p-3 sm:p-5 md:p-6 lg:p-8 max-w-7xl mx-auto">
      <div>
        <h1 className="text-xl sm:text-2xl md:text-3xl font-semibold text-[#061b31]">Global Filings</h1>
